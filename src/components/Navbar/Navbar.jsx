...
export default function Navbar() {
  ...
  if (doctor)
    return (
      <div className=" flex text-gray-400 border border-b-gray-300 sm:bg-gray-200 lg:bg-transparent items-center justify-between bg-transparent h-20 w-full  ">
        {/* navbar logo section */}
        <div>
          ...
          <h1 className="sm:hidden lg:block text-3xl font-sans font-bold text-blue-600 p-4 "> CareLife </h1>
        </div>
  ...
  if (profession === "patients")
    return (
      <div className=" flex items-center justify-between h-24 w-full bg-slate-950 bg-opacity-90 ">
        ...
        {/* navbar titles sections */}
        <div className=" h-full w-full hidden lg:flex bg-slate-700 rounded-3xl gap-4">
          {patientUserNavLinks?.map((item, index) => (
            <Link
              className={
                path === item.path
