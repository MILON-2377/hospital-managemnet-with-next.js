  ...
  return (
    <div className=" w-full p-5 ">
        ...
        <table className="table">
          ...
          <thead className=" bg-gray-100 ">
            <tr>
              ...
              <th className=" text-[18px] text-black font-semibold ">Doctor</th>
              ...
              <th className=" text-[18px] text-black font-semibold ">Amount</th>
      ...
      <div className=" mt-10 w-full p-5 flex items-center gap-3 justify-center ">
        ...
        <div>
          <button className=" px-4 py-3 transition-all duration-200 hover:bg-gray-200 rounded-md bg-gray-100 text-black font-[500] "> 1</button>
        </div>
