...
export default function ViewDetails() {
  ...
  return (
    <div className=" mt-5 p-4 w-full ">
      <p className=" text-2xl font-bold ">Medical Details</p>
      ...
      <div className=" p-5 rounded-md bg-white shadow border ">
        ...
        <div className=" flex items-center justify-between ">
          <div>
            ...
            <p className=" text-xl font-bold ">100 mg/dl</p>
          </div>
          <div>
            <p className=" flex items-center gap-1 ">
            ...
            <p className=" text-xl font-bold ">140 Mpm</p>
          </div>
          <div>
            <p className=" flex items-center gap-1 ">
          ...
          <div>
            ...
            <p className=" text-xl font-bold ">21 kg/m2</p>
          </div>
          <div>
            <p className=" flex items-center gap-1 ">
      ...
      <div className=" flex items-center justify-between mt-5 ">
        <label className=" relative">
          <input
            type="text"
            placeholder="Search"
            className=" px-4 py-2 rounded-md border bg-transparent focus:outline-none "
          />
              ...
              <div>
                ...
                <label className=" mt-5 flex flex-col gap-2">
                  ...
                  <DatePicker
                    ...
                    className=" w-full px-4 py-3 rounded-md placeholder:text-[14px] border focus:outline-none bg-transparent "
                  />
                </label>
              </div>
