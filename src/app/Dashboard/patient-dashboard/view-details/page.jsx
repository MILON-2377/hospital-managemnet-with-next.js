        ...
        <div className=" flex sm:flex-row flex-col gap-5 sm:gap-0 sm:items-center justify-between ">
          <div>
            <p className=" flex items-center gap-1 ">
              ...
              <span className="lg:text-[16px] text-[14px] ">Blood pressure</span>
            </p>
          ...
          <div>
            <p className=" flex items-center gap-1 ">
              ...
              <span className=" lg:text-[16px] text-[14px] ">Glucose Level</span>
            </p>
          ...
          <div>
            <p className=" flex items-center gap-1 ">
              ...
              <span className="lg:text-[16px] text-[14px] ">Body Temperature</span>
            </p>
      ...
      <div>
        <dialog id="my_modal_3" className=" rounded-md ">
          <div className="  bg-white shadow-md p-5 ">
            ...
            <form 
            onSubmit={handleAddMedicalDetails}
            className=" ">
              <div>
