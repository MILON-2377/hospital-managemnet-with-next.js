        ...
        <div className=" flex-1 border rounded-md p-5 ">
          ...
          <div className=" w-full flex items-center justify-between gap-5 mt-5 ">
            ...
            <div className=" w-full flex flex-col gap-5 items-center ">
              ...
              <Link href="/Dashboard/patient-dashboard/view-details" className=" flex items-center gap-3 px-4 py-2 rounded-md bg-slate-800 transition-all hover:bg-opacity-80 active:bg-opacity-70 active:scale-95 text-white font-semibold ">
                View Details{" "}
                <span>
